...
public class Zadanie1 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Vector3 Max = GetComponent<MeshRenderer>().bounds.max;//maksymalne koordynaty platformy
        Vector3 Min = GetComponent<MeshRenderer>().bounds.min;//minimalne koordynaty
    ...
    {
        List<Material> kolory = new List<Material>() { kolor1, kolor2, kolor3, kolor4, kolor5 };//wstawianie kolorow do listy
        Debug.Log("wywo³ano coroutine");
        foreach(Vector3 pos in positions)
        {
            block.GetComponent<MeshRenderer>().material = kolory[UnityEngine.Random.Range(0,5)];//losowanie koloru z listy
